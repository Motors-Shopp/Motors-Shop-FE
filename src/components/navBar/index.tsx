...
function NavBar(): JSX.Element {
    ...
    return <StyleNavBar>
        {modal && <NavmodalCreateAnuncioBar setTipoVeicle={setTipoVeicle} errors={errors} register={register} onSubmitFunction={onSubmitFunction} handleSubmit={handleSubmit} setModal={setModal}></NavmodalCreateAnuncioBar>}
        <div className="conteiner">
            <div className="title">
                <h2 className="Pdesktop">Velocidade e experiência em um lugar feito para você</h2>
            </div>
