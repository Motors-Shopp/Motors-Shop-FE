  ...
  return (
    <StyleModalCreateAnuncio>
      ...
      <div className="barCriarAnuncio">
            <p className="textAjusting2">Criar anuncio</p>
            <div
            onClick={() => {
                setModal(false);
            }}
        ...
        <div className="anoKMPreco">
            <div>
            <p className="textAjusting3">Ano</p>
            <input {...register("Ano")} placeholder="Ano" className="inputModal2" type="text" />
            </div>
            <div>
            <p className="textAjusting3">Quilometragem</p>
            <input
            ...
            <div>
            <p className="textAjusting3">Preço</p>
        ...
        <p className="textAjusting4">tipo de veiculo</p>
        <div className="conteinerBtnModal2">
        ...
        <input {...register("imagemDaCapa")} placeholder="imagem da capa" className="inputModal4" type="text" />
        <p className="textAjusting1">1* imagem da galeria</p>
        <input
            placeholder="1* imagem da galeria"
            className="inputModal4"
            type="text"
